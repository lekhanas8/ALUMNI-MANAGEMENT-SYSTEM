...
<html lang="en">
   <head>
      ...
      <title>College Alumni System || Cancel Job Post</title>
   ...
   <body class="inner_page tables_page">
      <div class="full_container">
       ...
       $ret = "SELECT ID FROM tbljobpost where Status='Cancelled'";
$query1 = $dbh -> prepare($ret);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$total_rows=$query1->rowCount();
$total_pages = ceil($total_rows / $no_of_records_per_page);
$sql="SELECT * from tbljobpost where Status='Cancelled' LIMIT $offset, $no_of_records_per_page";
