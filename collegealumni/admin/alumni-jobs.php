...
<html lang="en">
   <head>
      ...
      <title>College Alumni System || All Job Post</title>
   ...
   <body class="inner_page tables_page">
      <div class="full_container">
                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2> Jobs Posted by <?php echo $_GET['aname'];?></h2>
                           </div>
                        </div>
                     </div>
                     <!-- row -->
       ...
       $ret = "SELECT ID FROM tbljobpost where AlumniID='$aid'";
$query1 = $dbh -> prepare($ret);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$total_rows=$query1->rowCount();
$total_pages = ceil($total_rows / $no_of_records_per_page);
$sql="SELECT * from tbljobpost where AlumniID='$aid' LIMIT $offset, $no_of_records_per_page";
