...
<html lang="en">
   <head>
      ...
      <title>College Alumni System || New Job Post</title>
...
$sql="SELECT * from tbljobpost where Status is null LIMIT $offset, $no_of_records_per_page";
...
<?php } ?> 
                                         ...
                                         <td class="d-none d-sm-table-cell"><a href="view-jobpost-detail.php?vid=<?php echo htmlentities ($row->ID);?>" class="btn btn-primary btn-sm"  target="_blank">View Details</a></td>
                                    </tr><?php $cnt=$cnt+1;}} ?>
                                       </tbody>
                                    </table>
                                    <div align="left">
